# TODO List for Android OpenCV OpenGL Web Assessment
...
- [x] Set up JNI methods for frame passing and processing

## Web Viewer
- [x] Create TypeScript web page for displaying sample frame
- [x] Add basic UI for frame stats (FPS, resolution)
